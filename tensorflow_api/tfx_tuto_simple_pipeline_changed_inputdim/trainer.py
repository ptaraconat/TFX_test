...
def _input_fn2(file_pattern, data_accessor, schema, batch_size):
    ...
    #file_list = data_accessor.get_data_files(file_pattern) 
    #print("######## File List ###########")
    #print(file_list)
    #file_paths = data_accessor.get_split_uris(file_pattern)

    # Create a dataset of file paths
    #dataset = tf.data.Dataset.from_tensor_slices(file_paths)

    #dataset = data_accessor.tf_dataset_factory(file_pattern,tfxio.TensorFlowDatasetOptions(batch_size=batch_size),schema=schema).repeat()
